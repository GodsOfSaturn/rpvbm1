    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <a href="generate_report.php" id="generate-report-btn" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                ...
                <div class="d-flex flex-wrap justify-content-between">
                    ...
                    <div class="card mb-4" style="width: 22%; min-width: 250px;">
                        <div class="card-body">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Bin Progress</div>
                            <div id="tasks-progress" class="h5 mb-0 font-weight-bold text-gray-800">0%</div>
                            <div class="progress">
                                <div id="tasks-progress-bar" class="progress-bar" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    generateReportButton.addEventListener('click', function(event) {
        ...
        window.location.href = 'generate_report.php';  // Trigger PHP script to generate the report
    });
});
